...
public class SplashProgress
{
    ...
    public static void drawSplash(final TextureManager tm) {
        ...
        if (SplashProgress.splash == null) {
            SplashProgress.splash = new ResourceLocation("foxclient/splash.png");
        }
    ...
    private static void drawProgress() {
        ...
        final double calc = nProgress / 6.0 * sr.getScaledWidth();
        ...
        final String step = String.valueOf(SplashProgress.PROGRESS) + "/" + 6;

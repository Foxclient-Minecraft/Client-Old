...
public class FoxClientMovementInput extends MovementInput {
	...
	public FoxClientMovementInput(GameSettings gameSettings) {
	...
	public void updatePlayerMoveState() {
		...
		if(ModInstances.getModToggleSprint().flyBoost && player.capabilities.isCreativeMode && player.capabilities.isFlying && (mc.getRenderViewEntity() == player) && sprint) {
			...
			boostedFlySpeed = originalFlySpeed * ModInstances.getModToggleSprint().flyBoostFactor;

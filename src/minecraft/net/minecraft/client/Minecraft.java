...
import foxclient.gui.mainmenu.GuiClientMenu;
import foxclient.util.other.FoxClientMovementInput;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        SplashProgress.setProgress(1, "Minecraft - Iniciando Minecraft");
        ...
        SplashProgress.setProgress(2, "Minecraft - Iniciando ModelManager");
        ...
        SplashProgress.setProgress(3, "Minecraft - Iniciando EntityRenderer");
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        SplashProgress.setProgress(4, "Minecraft - Iniciando TexturePacks");
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.renderGlobal = new RenderGlobal(this);
        SplashProgress.setProgress(5, "Minecraft - Iniciando Renderizado");
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new GuiClientMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new GuiClientMenu());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Foxclient 1.8.8");
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
            	inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("foxclient/icon/icon16.png"));
            	inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("foxclient/icon/icon32.png"));
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof GuiClientMenu)
        {
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Cliente.getInstance().getDiscordRP().update("En Linea", "Jugando Solo");
    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            this.thePlayer.movementInput = new FoxClientMovementInput(this.gameSettings);

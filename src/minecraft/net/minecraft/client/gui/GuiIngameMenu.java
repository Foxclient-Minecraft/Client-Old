...
import foxclient.gui.GuiElegirCosmetic;
import foxclient.gui.GuiMultiplayerIngame;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if(mc.isSingleplayer()) {
        	...
        	this.buttonList.add(new GuiButton(100, this.width / 2 + 2, this.height / 4 + 96 + i, 98, 20, "Servidores"));
        }
        
        this.buttonList.add(new GuiButton(1000, this.width / 2 - 50, this.height / 4 + 73 + i, 98, 20, "Cosmeticos"));
        ...
        switch (button.id)
        {
            ...
            case 1:
                ...
                else if (flag1)
                {
                    ...
                    realmsbridge.switchToRealms(new GuiClientMenu());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new GuiClientMenu()));
                }
            ...
            case 100:
            	...
            	break;
            case 1000:
            	this.mc.displayGuiScreen(new GuiElegirCosmetic());
            	break;
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontUtil.normal.drawCenteredString( I18n.format("menu.game", new Object[0]), this.width / 2, 40, 16777215);

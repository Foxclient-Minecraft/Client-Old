...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
        if(msg.equalsIgnoreCase(".discord")) {
        	 Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(new ChatComponentText("Puedes unirte al Discord de Foxclient aqui: https://discord.gg/XAzENGpSxm"));
        }else {

...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof GuiClientMenu)
        {
            this.updateMainMenu((GuiClientMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(GuiClientMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = GuiClientMenu.class.getDeclaredFields();
